...
- `7.0.260c` (full profile; custom charts — retains the 7.0.x note-family layout, see `docs/offsets/7.0.260c-offsets.md`)
...
- **Documented sites** — `docs/offsets/6.12.11c-offsets.md`, `docs/offsets/6.16.2c-offsets.md`, `docs/offsets/6.16.8c-offsets.md`, `docs/offsets/7.0.0c-offsets.md`, `docs/offsets/7.0.1c-offsets.md`, `docs/offsets/7.0.255c-offsets.md`, and `docs/offsets/7.0.260c-offsets.md`.
